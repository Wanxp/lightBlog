...
@DynamicInsert(true)
@DynamicUpdate(true)
public class Tcontent implements java.io.Serializable,IEntity{
	...
	//date formats
	public static final String FORMAT_ADDTIME = com.wanxp.util.Constants.DATE_FORMAT_FOR_ENTITY;
	public static final String FORMAT_UPDATETIME = com.wanxp.util.Constants.DATE_FORMAT_FOR_ENTITY;
